...
// render - widget
// const ThreeDModels = Loadable(lazy(() => import("pages/threed/list")));
...
//   lazy(() => import("pages/maintenance/coming-soon/coming-soon2"))
// );
...
//   lazy(() => import("pages/extra-pages/price/price1"))
// );
// const PricingPage2 = Loadable(
//   lazy(() => import("pages/extra-pages/price/price2"))
// );

// const Profile = Loadable(lazy(() => import("pages/user-page")));
// const UserTabProfile = Loadable(lazy(() => import("pages/user/TabPersonal")));
// const UserTabChangePassword = Loadable(
//   lazy(() => import("pages/user/TabPassword"))
// );
