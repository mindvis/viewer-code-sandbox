...
export const TablePagination = ({ gotoPage, rows, setPageSize, pageSize, pageIndex, initialPageSize }: TablePaginationProps) => {
  // export const TablePagination = ({ gotoPage, rows, setPageSize, pageSize, pageIndex, initialPageSize, deleteUserUpdateList }: { model: TablePaginationProps,deleteUserUpdateList: (id: string) => void }) => {
